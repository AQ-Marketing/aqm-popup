...
class AQM_Popup_Admin {
    ...
    public function register_settings() {
        ...
        add_settings_field( 'edge_to_edge_mode',      __( 'Edge-to-edge content',   'aqm-popup' ), array( $this, 'field_checkbox' ), self::PAGE_SLUG, 'aqm_popup_behavior', array( 'key' => 'edge_to_edge_mode', 'description' => __( 'Override Divi\'s default section padding (4% top/bottom), row padding (27px top/bottom), row width (80%), and image-module bottom margin inside the popup. Use for popups that should be a single edge-to-edge image or full-bleed content. Any padding/width/margin you explicitly set on a section, row, or column in Divi Builder will still apply — Divi-UI overrides win over the plugin\'s reset.', 'aqm-popup' ) ) );
